    ...
    children: [
      {
        ...
        iconKey: 'User',
        moduleKey: 'users.user_management',
        action: 'read',
        sortOrder: 10,
      },
      {
        ...
        iconKey: 'Shield',
        moduleKey: 'users.role_management',
        action: 'read',
        sortOrder: 20,
      },
    ],
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        iconKey: 'CreditCard',
        moduleKey: 'finance.fee_collection',
        action: 'read',
        sortOrder: 20,
      },
    ],
